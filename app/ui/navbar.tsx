...
export default function NavBar() {
  return (
    <div className="flex justify-between items-center sm:px-5 md:px-8 lg-px-12">
        <div className="flex items-center gap-2">
            <button className="font-title-header text-2xl w-10 h-10 bg-primary rounded-full">M</button>
